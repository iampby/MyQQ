...
QT_MOC_LITERAL(1, 7, 13), // "imagesChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 2), // "id"
QT_MOC_LITERAL(4, 25, 10), // "findPixmap"
QT_MOC_LITERAL(5, 36, 9), // "setPixmap"
QT_MOC_LITERAL(6, 46, 3) // "pix"

    },
    "Images\0imagesChanged\0\0id\0findPixmap\0"
    "setPixmap\0pix"
};
...
static const uint qt_meta_data_Images[] = {
 ...
 // methods: parameters
    QMetaType::QPixmap, QMetaType::QString,    3,
...
void Images::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->imagesChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: { QPixmap _r = _t->findPixmap((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QPixmap*>(_a[0]) = std::move(_r); }  break;
        case 2: _t->setPixmap((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Images::imagesChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Images::imagesChanged(QString _t1)
{
