...
QT_MOC_LITERAL(3, 18, 13) // "emitHidePopup"

    },
    "ComboBox\0clicked\0\0emitHidePopup"
};
...
void ComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->emitHidePopup(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ComboBox::*)();
        ...
        {
            using _t = void (ComboBox::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComboBox::emitHidePopup)) {
                *result = 1;
                return;
            }
        }
