...
QT_MOC_LITERAL(1, 11, 10), // "imgClicked"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "nameClicked"
QT_MOC_LITERAL(4, 35, 16) // "addButtonClicked"

    },
    "UserWidget\0imgClicked\0\0nameClicked\0"
    "addButtonClicked"
};
...
void UserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->imgClicked(); break;
        case 1: _t->nameClicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWidget::imgClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UserWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWidget::nameClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (UserWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWidget::addButtonClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void UserWidget::imgClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void UserWidget::nameClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void UserWidget::addButtonClicked()
{
