...
QT_MOC_LITERAL(1, 9, 15), // "closeBtnClicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "minBtnClicked"
QT_MOC_LITERAL(4, 40, 22), // "forwardSiganlForMinBtn"
QT_MOC_LITERAL(5, 63, 24) // "forwardSiganlForCloseBtn"

    },
    "titleBar\0closeBtnClicked\0\0minBtnClicked\0"
    "forwardSiganlForMinBtn\0forwardSiganlForCloseBtn"
};
...
void titleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->minBtnClicked(); break;
        case 2: _t->forwardSiganlForMinBtn(); break;
        case 3: _t->forwardSiganlForCloseBtn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&titleBar::closeBtnClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (titleBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&titleBar::minBtnClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void titleBar::closeBtnClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void titleBar::minBtnClicked()
{
